...
<div>
  <div class="p-4 bg-gray-600 shadow-sm text-center text-white">
    VUE - TAILWIND CSS - RAJA ONGKIR - @_.ARIFAAH
  </div>
  <div class="grid sm:grid-cols-12 md:grid-cols-4 gap-4 p-4">
    <div class="bg-white p-3 shadow-sm rounded">
      ...
      <div class="mt-4 pb-2">
        ...
        <select name="" id="" class="w-full border bg-white rounded px-3 py-2 outline-none" @change="getCitiesOrigin" v-model="state.province_origin">
      ...
      <div class="mt-4 pb-2">
        ...
        <select name="" id="" class="w-full border bg-white rounded px-3 py-2 outline-none" v-model="state.city_origin">
    ...
    <div class="bg-white p-3 shadow-sm rounded">
      ...
      <div class="mt-4 pb-2">
        <label class="mb-2">PROVINSI</label>
        <select name="" id="" class="w-full border bg-white rounded px-3 py-2 outline-none" @change="getCitiesDestination" v-model="state.province_destination">
          <option class="py-1" v-for="province in provinces" :key="province.id" :value="province.province_id">{{province.province}}</option>
        </select>
      </div>
      <div class="mt-4 pb-2">
      ...
      <div class="bg-white p-3 shadow-sm rounded">
        ...
        <div class="mt-4 pb-2">
          ...
          <select name="" id="" class="w-full border bg-white rounded px-3 py-2 outline-none" v-model="state.courier">
        ...
        <div class="mt-4 pb-2">
          ...
          <input type="text" class="p-2 bg-gray-200 rounded w-full shadow hover:bg-white" v-model="state.weight" placeholder="Masukan Berat (Gram)">
        </div>
      </div>
      <div>
